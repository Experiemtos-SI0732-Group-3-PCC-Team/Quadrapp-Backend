package com.upc.quadrapp.iam.infrastructure.authorization.sfs.pipeline;

import com.upc.quadrapp.iam.infrastructure.authorization.sfs.model.UsernamePasswordAuthenticationTokenBuilder;
...
public class BearerAuthorizationRequestFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return path.equals("/api/v1/authentication")
